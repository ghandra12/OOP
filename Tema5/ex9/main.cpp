...
public:
    ...
    void computePerimeter(){
        cout<<"Vom calcula PERIMETRUL urmatoarei forme: ";
    }
};
...
public:
   ...
   void showMessage(){
    ...
    void computePerimeter(){
       ...
       cout<<"\nMy Rectangle Perimeter= "<<Perimeter;
    }
};
...
int main()
{
    ...
    Square mySquare("My Square",4);
    mySquare.computePerimeter();
